...
=== Bug fixes
* Previously, the **Observe** menu of the administrator perspective could have been duplicated depending of the installed {ocp-product-title} version. Now, the **Observe** menu appears only once. (link:https://issues.redhat.com/browse/NETOBSERV-2139 [*NETOBSERV-2139*])
