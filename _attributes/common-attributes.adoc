...
:SMv2Version: 2.6.6
//SMv2Version must be updated with each 2.x release because users can only migrate from the latest 2.x.z version. Update 02/24/202 for service-mesh-docs-3.0
//Kiali Operator
