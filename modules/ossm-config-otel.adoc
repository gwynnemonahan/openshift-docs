...
[NOTE]
====
Once you verify that you can see traces, lower `randomSamplingPercentage` or set it to `default` to reduce the number of requests.
====
...
oc istio.io/rev=<revision-name> # <1>
