...
+
The Network Observability Operator does not manage Loki; you must install it separately by using the {loki-op}. Similarly, you must manage Prometheus or any custom receivers independently.
...
+
As with other deployment models, the Network Observability Operator does not manage the data stores.
