...
// Commenting out for now because the PR for this content has not been merged. Inserting xref causes build to fail so this is place holder text. xref will be added when the PR for Configuring OTEL with Service Mesh has been merged.* [Configuring {OTELName} with Service Mesh]
