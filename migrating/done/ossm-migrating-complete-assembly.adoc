...
Optionally, if you already have Kiali installed, before you delete {SMProduct} {SMv2Version}, you can verify that all data plane namespaces have been migrated by checking the Kiali **Mesh** page. To learn more about the Kiali **Mesh** page, see "Istio infrastrcuture status (Kiali.io)".
...
* link:https://kiali.io/docs/features/istio-component-status/#control-plane-namespace[Istio infrastrcuture status (Kiali.io)]
